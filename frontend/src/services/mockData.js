...
export const MOCK_ANALYSES = [
  {
    ...
    indicators: [
      ...
      { id: 'cred_harvest_form', group: 'url', label: 'Embedded Credential Harvesting Form', evidence: 'Contains disguised login hyperlink pointing to unverified external IP http://185.220.101.42/auth/login.php', points: 20 },
    ...
    explanation: {
      ...
      reasons: [
        ...
        { group: 'url', reason: 'Direct IP credential harvesting portal', points: 20, evidence: 'Link destination directs to raw overseas host 185.220.101.42.' },
  ...
  },
  {
    ...
    indicators: [
      ...
      { id: 'urgency_coercion', group: 'urgency', label: 'Urgent Wire Transfer Demand', evidence: 'Demands bypass of standard corporate verification controls due to "time-sensitive closing".', points: 13 }
    ],
    explanation: {
  ...
  },
  {
    ...
    indicators: [
      ...
      { id: 'cred_phishing_link', group: 'url', label: 'Credential Harvesting Target', evidence: 'Directs to phishing kit http://91.240.118.50/m365/login.php', points: 25 },
      ...
      { id: 'auth_fail', group: 'auth', label: 'DMARC/SPF Alignment Failure', evidence: 'Unauthenticated relay.', points: 10 }
    ],
    explanation: {
      ...
      reasons: [
        ...
        { group: 'url', reason: 'Known credential phishing kit', points: 25, evidence: 'Hosted at http://91.240.118.50/m365/login.php.' }
      ],
...
export const MOCK_CAMPAIGNS = [
  {
    ...
    members: [
      { id: 'demo-sample-5', subject: 'Action Required: Microsoft 365 Password Expiration Alert', sender: { address: 'admin-support@auth-portal-verify365.net' }, risk_score: 85, classification: 'HIGH' },
      { id: 'demo-sample-6', subject: 'Billing Invoice #8410 Overdue - Immediate Payment', sender: { address: 'admin-billing@auth-portal-verify365.net' }, risk_score: 85, classification: 'HIGH' },
      { id: 'demo-sample-7', subject: 'Account Security Notice: Re-Authenticate Session', sender: { address: 'admin-account@auth-portal-verify365.net' }, risk_score: 85, classification: 'HIGH' }
    ],
    graph: {
      nodes: [
        { id: 'CMP-7F2A', label: 'Campaign CMP-7F2A', group: 'campaign', radius: 26 },
        { id: 'demo-sample-5', label: 'M365 Password Alert', group: 'email', radius: 18, risk_score: 85, classification: 'HIGH' },
        { id: 'demo-sample-6', label: 'Billing Overdue Notice', group: 'email', radius: 18, risk_score: 85, classification: 'HIGH' },
        { id: 'demo-sample-7', label: 'Account Re-Auth Notice', group: 'email', radius: 18, risk_score: 85, classification: 'HIGH' },
