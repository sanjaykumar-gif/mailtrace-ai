    ...
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1.75rem' }} className="fade-in">
      ...
      <div style={{ textAlign: 'center', paddingTop: '0.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div style={{
          ...
          {isDemo ? '🧪 Prototype Demo Mode Active — Full Telemetry Unlocked' : 'Explainable Threat &amp; Campaign Correlation Engine'}
        </div>
        ...
        {isDemo ? (
          ...
          <div style={{ marginTop: '1.25rem', display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            >
              ⚡ Enable Prototype Demo Mode (For Evaluators)
            </button>
          </div>
        )}
      </div>
